...
def admin_all_assignments():
    try:
        ...
        return redirect('https://fed.princeton.edu/cas/login?service=http://saltytyga.herokuapp.com/' + "admin/master_all_assignments?assignment=" + request.args.get('assignment') + "&" + request.args.get('course'))
    ...
    admin_netid = isLoggedIn(ticket, "admin/master_all_assignments?assignment=" + request.args.get('assignment') + "&" + request.args.get('course'))
