  ...
  Annotator.Plugin.AnnotatorViewer = (function(_super) {
    ...
    AnnotatorViewer.prototype.onButtonClick = function(event, type) {
     ...
     AnnotatorViewer.prototype.onDeleteMouseover = function(event) {
       $(event.target).attr('src', '../static/annotator_view/src/img/papelera_over.png');
    };

     AnnotatorViewer.prototype.onDeleteMouseout = function(event) {
      $(event.target).attr('src', '../static/annotator_view/src/img/icono_eliminar.png');
    };
    ...
    AnnotatorViewer.prototype.mascaraAnnotation = function(annotation) {
      ...
      var borrar = "<img src=\"../static/annotator_view/src/img/icono_eliminar.png\" class=\"annotator-viewer-delete\" title=\""+ i18n_dict.Delete +"\" style=\" float:right;margin-top:3px;\"/>";

      /* || annotation.permissions.read.length===0 */
      if (annotation.estat==1)
      {
        anotacio_compartida = "<img src=\"../static/annotator_view/src/img/Compartido.png\" title=\""+ i18n_dict.share +"\" style=\"margin-left:5px\"/>"
      }
      ...
      var anotacio_capa =  '<div class="annotator-marginviewer-text"><div class="'+anotation_color+' anotator_color_box"></div><div class="anotador_text">'+ annotation.text + '</div></div><div class="annotator-marginviewer-text"></div><div class="annotator-marginviewer-quote">'+ annotation.quote + '</div><div class="annotator-marginviewer-footer"><span class="'+class_label+'">' + annotation.user + '</span>'+anotacio_compartida+borrar+'</div>';
      return anotacio_capa;
    };

    AnnotatorViewer.prototype.createAnnotationPanel = function(annotation) {
      var anotacio_capa =  '<div  class="annotations-list-uoc" style="background-color:#ddd;"><div id="annotations-panel"><span class="rotate" title="'+ i18n_dict.view_annotations +' '+ i18n_dict.pdf_resum +'" style="padding:5px;background-color:#ddd;position: absolute; top:10em;left: -50px; width: 155px; height: 110px;cursor:pointer">'+ i18n_dict.view_annotations +'<span class="label-counter" style="padding:0.2em 0.3em;float:right" id="count-anotations">0</span></span></div><div id=id="' + annotation.uri + '" style="height:80%"><ul class="container-anotacions"></ul></div></div>';
      return anotacio_capa;
    };
